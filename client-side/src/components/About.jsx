        ...
        <Section section-name={"about"}>
            ...
            <div className="research-description">
                ...
                <p className="block-2">
                    ...
                    Visit the publication of our study <a href="http://dx.doi.org/10.13140/RG.2.2.34355.95525">here</a>. Note that the dataset that is required in order to use test this application is also 
                    available <a href="https://data.mendeley.com/datasets/w8fxrg4pv5/2">here</a>
                </p>
            </div>
        </Section>
    )
